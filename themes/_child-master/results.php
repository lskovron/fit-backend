...
<div id="overall" style="text-align:center"><h2>Overall FIT Score:<br><span class="total" style="color:#1e7ce1"></span>/<span style="color:#0140c9">100</span></h2></div>
...
<div  class="result-section">
    <div class="result-analysis">
        ...
        <div class="col2">
            <h3 class="dim-score"><span id="cognitive-score" style="color:<?php echo $cog_colors[6]; ?>;"></span> out of 100</h3>
    ...
    <div class="result-analysis">
        ...
        <div class="col2">
            <h3 class="dim-score"><span id="physical-score" style="color:<?php echo $phy_colors[6]; ?>;"></span> out of 100</h3>
    ...
    <div class="result-analysis">
        ...
        <div class="col2">
            <h3 class="dim-score"><span id="financial-score" style="color:<?php echo $fin_colors[6]; ?>;"></span> out of 100</h3>
    ...
    <div class="result-analysis">
        ...
        <div class="col2">
            <h3 class="dim-score"><span id="emotional-score" style="color:<?php echo $emo_colors[6]; ?>;"></span> out of 100</h3>
    ...
    <div class="result-analysis">
        ...
        <div class="col2">
            <h3 class="dim-score"><span id="spiritual-score" style="color:<?php echo $spi_colors[6]; ?>;"></span> out of 100</h3>
